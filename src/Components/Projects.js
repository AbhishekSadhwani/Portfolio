...
export const Projects = () => {
  return (
    <section className='border-b border-gray-200 dark:border-neutral-900 pb-4'>
        <motion.h2 initial={{y:-100,opacity:0}} whileInView={{y:0,opacity:1}} viewport={{ once: true }} transition={{duration:0.5}} className='text-center text-2xl md:text-4xl text-neutral-900 my-20 dark:text-neutral-300'>Projects</motion.h2>
        <div>
