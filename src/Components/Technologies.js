...
const Technologies = () => {
    ...
    return (
        <section className='border-b border-neutral-900 pb-24'>
            <motion.h2 initial={{y:-100,opacity:0}} whileInView={{y:0,opacity:1}} viewport={{ once: true }} transition={{duration:1.5}} className='text-center text-4xl my-20'>Technologies</motion.h2>
