            ...
            <div className="flex flex-wrap justify-center">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <motion.h1 variants={(heroTransition(0))} initial="hidden" animate="visible" className="text-4xl pb-16 lg:text-7xl lg:mt-16 font-thin tracking-tight">Abhishek Sadhwani</motion.h1>
